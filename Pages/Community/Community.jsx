...
const Community = () => {
    return (
      ...
      style={{
        backgroundImage:
          "url('https://i.ibb.co/KxMR7kSd/sergei-a-he-LWtu-AN3c-unsplash.jpg')",
    ...
    >
      ...
      <div className="relative z-10 text-white px-4">
        <h2 className="text-3xl font-bold mb-2">Join Our Green Community</h2>
        <p className="mb-5 text-sm md:text-base">
          Get plant care tips and fresh updates straight to your inbox.
        </p>
